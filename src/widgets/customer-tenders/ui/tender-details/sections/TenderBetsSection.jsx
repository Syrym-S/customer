        ...
        {bets.length === 0 ? (
          ...
          <Stack
            ...
            sx={{
              ...
              overflowY: isExpanded && bets.length > 6 ? "auto" : "visible",
                    ...
                    >
                      ...
                      {canAcceptBet && (
                        <Button
                          ...
                          onClick={() => handleOpenConfirm(bet, index)}
                          sx={{
                            height: 24,
                            px: 1,
                            py: 0,
        ...
        <DialogContent>
          ...
          >
            ...
            <Typography fontWeight={700} sx={{ mb: 1 }}>
              {formatMoney(confirmBet?.bet.amount, confirmBet?.bet.currency)}
            </Typography>
