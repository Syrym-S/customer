              ...
              >
                ...
                >
                  <TextField
                    ...
                    value={cargo.name || ""}
                    onChange={(event) =>
                      handleCargoChange(index, "name", event.target.value)
                    }
                    fullWidth
                    size="small"
                  />
                  ...
                  <TextField
                    ...
                    onChange={(event) =>
                      handleCargoChange(index, "weight_kg", event.target.value)
                    }
                    fullWidth
                    size="small"
                  />
                  ...
                  >
                    ...
                    <TextField
                      ...
                      onChange={(event) =>
                        handleCargoChange(index, "width_cm", event.target.value)
                      }
                      fullWidth
                      size="small"
                    />
              ...
              leadCargos.map((cargo, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <InfoBadge label="Тип" value={cargo.type || "Не указано"} />
            ...
            <>
              ...
              >
                <TextField
                  ...
                  helperText={
                    isForwarderCreatedLead ? "Цена задана экспедитором" : ""
                  }
                  fullWidth
                  size="small"
                  sx={{
