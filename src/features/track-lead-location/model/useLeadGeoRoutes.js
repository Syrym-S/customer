...
export function useLeadGeoRoutes(leads) {
         ...
         const connection = openLeadGeoConnection({
            ...
            onPoints: (points) => {
               ...
               setGeoRoutes((prevRoutes) => {
                  ...
                  const routePoints = mapGeoPointsToRoutePoints(mergedPoints);
            ...
            onError: (error) => {
               ...
               console.warn('Lead GeoWS failed:', {
                  leadId,
                  error,
               });
            ...
            onAuthFailed: (payload) => {
               ...
               console.warn('Lead GeoWS auth failed:', {
                  leadId,
                  payload,
               });
